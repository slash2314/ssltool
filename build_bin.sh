...
CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -o build/${NAME}_win_amd64_"${VERSION}".exe
CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -o build/${NAME}_win_arm64_"${VERSION}".exe
